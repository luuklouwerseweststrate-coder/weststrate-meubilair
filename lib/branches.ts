...
export const BRANCHES: Branche[] = [
  // ── Per branche ────────────────────────────────────────────
  {
    ...
    projectSlugs: ["noordhuys-oude-tonge", "damen"],
    accent: "#A1367E",
  ...
  },
  {
    ...
    projectSlugs: [],
    accent: "#01B6E3",
    beeld: "/beelden/project-kantoortuin.png",
  },
  {
    slug: "onderwijs",
    ...
    projectSlugs: [],
    accent: "#009D46",
    beeld: "/beelden/sfeer-detail.png",
  },
  {
    slug: "horeca",
    naam: "Horeca",
    ...
    projectSlugs: ["zb-bibliotheek-middelburg"],
    accent: "#F29828",
  },
  ...
  // ── Per type ruimte ────────────────────────────────────────
  {
    ...
    projectSlugs: ["noordhuys-oude-tonge", "zb-bibliotheek-middelburg"],
    accent: "#F29828",
  },
  {
    slug: "vergaderruimte",
    ...
    projectSlugs: ["gemeente-schouwen-duiveland", "noordhuys-oude-tonge"],
    accent: "#009D46",
  ...
  // ── Voor je project ────────────────────────────────────────
  {
    ...
    projectSlugs: ["damen", "noordhuys-oude-tonge"],
    accent: "#A1367E",
  },
  {
    slug: "renovatie",
    ...
    projectSlugs: ["gemeente-schouwen-duiveland", "zb-bibliotheek-middelburg"],
    accent: "#673981",
  },
];
