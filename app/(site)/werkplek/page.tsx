...
export const metadata: Metadata = {
  ...
  description:
    "Stel in ̩̩n keer een complete werkplek samen: bureau, stoel en opbergen. Zie direct wat het kost en zet het in je offerte.",
};
    ...
    <div className="mx-auto max-w-content px-5 py-14">
      <Reveal className="max-w-2xl">
        ...
        <h1 className="text-4xl md:text-5xl">
          Stel in ̩̩n keer een complete werkplek samen
        </h1>
        <p className="mt-4 text-lg text-ink-2">
          Kies een bureau, een stoel en eventueel opbergruimte. Je ziet direct
          wat ̩̩n werkplek kost, en wat het wordt voor het aantal werkplekken
          dat je nodig hebt. In ̩̩n klik staat alles in je offerte.
        </p>
      </Reveal>
