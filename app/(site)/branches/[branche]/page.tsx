  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-content px-5 py-20">
        <Reveal className="rounded-3xl bg-ink px-8 py-14 text-center text-white md:px-16">
          <h2 className="mx-auto max-w-2xl text-3xl text-white md:text-4xl">
            Benieuwd wat we voor jouw ruimte kunnen betekenen?
          </h2>
